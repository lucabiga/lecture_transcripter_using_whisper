...
For remote transcription via web browser or API, you can run the included FastAPI server.
...
- **Web Interface**: http://localhost:8000 (drag & drop files)
...
📖 **For detailed API documentation and examples**, see [API_QUICKSTART.md](API_QUICKSTART.md)
